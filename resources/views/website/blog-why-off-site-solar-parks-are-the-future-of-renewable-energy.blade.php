      ...
      <div class="row">
        <div class="col">
          ...
          <p data-aos="fade-up" class="mb-5">
            ...
            solar
            parks are designed for large-scale energy generation, often covering acres of land. This setup not only
            maximizes solar exposure but also minimizes land use conflicts, making it a sustainable choice for
            large-scale
            energy projects.
          </p>
          ...
          <p data-aos="fade-up" class="mb-5">
            ...
            into
            electricity. Off-site solar parks use advanced tracking systems and high-efficiency panels to ensure maximum
            energy capture throughout the day. These parks are connected to the grid, delivering electricity directly to
          ...
          <h5 data-aos="fade-up" class="mb-4">Environmental Benefits</h4>
            <p data-aos="fade-up" class="mb-5">
              ...
              planet. The extensive green fields of solar panels not only generate electricity but also support
            ...
            <h5 data-aos="fade-up" class="mb-4">Reduction in Carbon Footprint</h4>
              <p data-aos="fade-up" class="mb-5">
                ...
                entering the atmosphere each year, making a substantial dent in climate change mitigation efforts.
                Enernew's energy parks are at the forefront, transforming barren lands into vibrant sources of clean
                energy.
              </p>
              ...
              <h5 data-aos="fade-up" class="mb-4">Conservation of Natural Resources</h4>
                <p data-aos="fade-up" class="mb-5">
                  ...
                  This is particularly vital in regions facing water scarcity, where traditional power plants strain
                  local
                  water resources.
                </p>
                ...
                <p data-aos="fade-up" class="mb-5">
                  ...
                  change
                  mitigation. Enernew's commitment to expanding these parks underscores their potential to transform
                  energy landscapes, driving us closer to a renewable energy future. These parks are not just
                ...
                <p data-aos="fade-up" class="mb-5">
                  ...
                  unmatched. For businesses, communities, and policymakers, the call to action is clear: support
                  off-site
